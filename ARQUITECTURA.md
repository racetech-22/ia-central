...
- MCP server propio del proyecto Django (para que la IA Central pueda leer/modificar su propio código), expuesto como tools nombradas y deterministas (`git_status`, `read_file`, `restart_web`…), nunca como shell abierto al modelo. Ver ADR-015, ADR-020, ADR-022.
