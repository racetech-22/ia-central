...
No modifiques ni borres nada. Terminá con un resumen en texto plano, en este orden: primero las DISCREPANCIAS reales de contenido (si hay alguna), con el ADR, la afirmación exacta, y qué encontraste en el repo en su lugar. Después, un bloque aparte para las discrepancias de INDEX.md (d1/d2/d3) si las hay, con la misma prioridad que las discrepancias de contenido — un INDEX.md desactualizado también es una fuente de verdad rota. Después, aparte y con menor énfasis, las AMBIGÜEDADES. Si no hay discrepancias, decilo explícitamente. No detalles los casos CORRECTOS uno por uno, mencionalos de forma agregada (cuántos, cuáles ADR).

Además de ese resumen en texto plano, terminá tu respuesta con una última línea, sola, exactamente 'ADR_CONTENT_STATUS=CLEAN' si no encontraste ninguna DISCREPANCIA de contenido ni discrepancia de INDEX.md (d1/d2/d3), o exactamente 'ADR_CONTENT_STATUS=DISCREPANCIES_FOUND' si encontraste al menos una de cualquiera de esos dos tipos. Las AMBIGÜEDADES por sí solas, sin ninguna DISCREPANCIA real, no cuentan para este marcador — dejalo en CLEAN si sólo hay ambigüedades. Esta línea tiene que aparecer literalmente, sin texto adicional en la misma línea, porque un proceso automático la va a buscar con grep." \
