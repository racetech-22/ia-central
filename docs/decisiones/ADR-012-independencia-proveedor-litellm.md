...
- Se agrega LiteLLM como servicio nuevo en `docker-compose.yml`: una pieza más que mantener y una configuración más que versionar (mapa de modelos, claves por proveedor).
